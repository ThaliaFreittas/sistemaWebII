...
<form style= "display: flex; flex-direction:column; width:20%; margin-top:10%; color: white; font-size:2.7vmin;"action="../controller/registrarSeguranca.php" method="GET">
    ...
    <br>
    <p>
    <INPUT style= "margin-top:3%;" type="checkbox" name="local" value="NA RUA DO HOTEL">NA RUA DO HOTEL. <br>  
    <INPUT style= "margin-top:3%;" type="checkbox" name="local" value="DENTRO DO HOTEL">DENTRO DO HOTEL. <br>
