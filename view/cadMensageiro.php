...
<form style= "display: flex; flex-direction:column; width:20%; margin-top:10%; color: white; font-size:2.7vmin;"action="../controller/registrarMensageiro.php" method="GET">
    ...
    <br>
    <p>
    <INPUT style= "margin-top:3%;" type="checkbox" name="turno" value="MANHÃ">MANHÃ. <br> 
    <INPUT style= "margin-top:3%;" type="checkbox" name="turno" value="TARDE">TARDE. <br>
    <INPUT style= "margin-top:3%;" type="checkbox" name="turno" value="NOITE">NOITE.<br>
