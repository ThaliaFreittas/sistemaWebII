...
<form style= "display: flex; flex-direction:column; width:20%; margin-top:10%; color: white; font-size:2.7vmin;"action="../controller/registrarCozinheiro.php" method="GET">
    ...
    <br>
    <p>
    <INPUT style= "margin-top:3%;" type="checkbox" name="especialidade" value="COMIDAS">COMIDAS.<br> 
    <INPUT style= "margin-top:3%;" type="checkbox" name="especialidade" value="SOBREMESAS">SOBREMESAS.<br>
