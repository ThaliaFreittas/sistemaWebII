...
<form style= "display: flex; flex-direction:column; width:20%; margin-top:10%; color: white; font-size:2.7vmin;"action="../controller/registrarFaxineiro.php" method="GET">
    ...
    QUAL O LOCAL AONDE LIMPA:
    <br>
    <p>
    <INPUT style= "margin-top:3%;" type="checkbox" name="local" value="NA AREA EXTERNA">NA AREA EXTERNA.<br>  
    <INPUT style= "margin-top:3%;" type="checkbox" name="local" value="NA AREA INTERNA">NA AREA INTERNA.<br>
