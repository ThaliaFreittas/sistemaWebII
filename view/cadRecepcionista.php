...
<form style= "display: flex; flex-direction:column; width:20%; margin-top:10%; color: white; font-size:2.7vmin;"action="../controller/registrarRecepcionista.php" method="GET">
    ...
    <br>
    <p>
    <INPUT style= "margin-top:3%;" type="checkbox" name="tarefa" value="VERIFICAR CHECK-IN">VERIFICA CHECK-IN. <br>  
    <INPUT style= "margin-top:3%;" type="checkbox" name="tarefa" value="FAZ CHECK-IN">FAZ CHECK-IN.<br> 
